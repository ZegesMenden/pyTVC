...
class Rocket:
    ...
    def __init__(self, dryMass: float, inertia: Vector3, position: Vector3, velocity: Vector3, rotation: Quaternion, rotVel: Vector3):
        ...
        self._rigidBody = RigidBody(dryMass, inertia, position, velocity, rotation, rotVel)
